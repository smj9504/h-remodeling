...
export default async function ContactPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const translations = {
    ...
    form: {
      ...
      successCta: t('form.successCta'),
      error: t('form.error'),
      reassurance: t('form.reassurance'),
      phoneHint: t('form.phoneHint'),
      messagePlaceholder: t('form.messagePlaceholder'),
      nameRequired: t('form.nameRequired'),
      nameMaxLength: t('form.nameMaxLength'),
      phoneRequired: t('form.phoneRequired'),
      phoneInvalid: t('form.phoneInvalid'),
      emailInvalid: t('form.emailInvalid'),
      serviceRequired: t('form.serviceRequired'),
      messageRequired: t('form.messageRequired'),
      messageMaxLength: t('form.messageMaxLength'),
    ...
    sidebar: {
      contactInfo: t('sidebar.contactInfo'),
      serviceAreas: t('sidebar.serviceAreas'),
      maryland: t('sidebar.maryland'),
      virginia: t('sidebar.virginia'),
      dc: t('sidebar.dc'),
      marylandAreas: t('sidebar.marylandAreas'),
      virginiaAreas: t('sidebar.virginiaAreas'),
      dcAreas: t('sidebar.dcAreas'),
    },
    services: [
